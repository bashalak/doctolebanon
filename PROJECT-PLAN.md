...
- [ ] Add a **doctor sign-up** page (so doctors can "register")
- [ ] Add **language toggle** (English / French / Arabic + right-to-left layout)
...
- [ ] Create a free **GitHub** account (to store the code safely)
